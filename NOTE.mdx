...
| **bastion/**       | Bastion EC2 Instance, SG, SSM Policy                                         | Dùng cho secure jump vào private subnet or chỉ SSM; Gán role riêng chỉ cho IAM nhóm quản trị.|
...
| **monitoring/**    | Alert, notify, tích hợp monitoring (Datadog, PagerDuty, Slack, ... )         | Tách các channels/endpoint ra riêng cho dễ audit và maintain                                 |
